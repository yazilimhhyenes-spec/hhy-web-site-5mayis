...
import nutProcessingBanner from "@/assets/nut-processing.png";
import agricultureBanner from "@/assets/agricultural-areas.webp";
...
export const BRANDS = [
  ...
  },
  {
    ...
    logo: enderLogo,
    banner: chocolateBanner,
    headline: "Industrial chocolate know-how for retail, export, and private label production.",
    description:
      "Ender Chocolate is HHY Group's chocolate manufacturing brand for private label, OEM confectionery, chocolate bars, filled chocolates, wafers, coated products, and export-ready retail production.",
    about:
      "Ender Chocolate is HHY Group's dedicated chocolate manufacturing brand, created for scalable confectionery production, private label chocolate projects, and OEM snack development. The brand brings together industrial chocolate know-how, recipe adaptation, packaging readiness, and export-oriented production planning for retailers, distributors, importers, and confectionery brands that need dependable manufacturing capacity.",
    content: [
  ...
  },
  {
    ...
    description:
      "SN4CK is HHY Group's modern snack and protein bar brand for private label protein bars, OEM snack products, nut-based bars, chocolate-coated bars, and on-the-go retail formats.",
    about:
      "SN4CK is HHY Group's modern snack brand created around protein bars, snack bars, nut-based formats, chocolate-coated bars, and on-the-go retail products. The brand is positioned for customers looking for private label protein bar manufacturing, OEM snack development, nutrition-led product concepts, and flexible retail-ready formats for modern consumer channels.",
    content: [
  ...
  },
  {
    ...
    description:
      "Cerezshop is HHY Group's consumer snack brand for nuts, freeze-dried fruits, dried fruits, chocolate-coated snacks, private label snack ranges, and retail-ready everyday products.",
    about:
      "Cerezshop brings HHY Group's snack expertise into a consumer-facing range of nuts, freeze-dried fruits, dried fruits, chocolate-coated products, and everyday snack selections. The brand is built for variety, convenience, private label snack development, and reliable retail supply across both traditional nut categories and modern snack formats.",
    content: [
